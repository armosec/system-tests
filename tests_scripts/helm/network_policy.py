...
class NetworkPolicy(BaseNetworkPolicy):
    ...
    def start(self):
        ...
        self.run_exec_cmd(namespace=namespace, pod_name=pod_name, cmd="curl https://google.com", repeat=1)
        self.run_exec_cmd(namespace=namespace, pod_name=pod_name, cmd="curl https://wikipedia.org", repeat=1)
...
class NetworkPolicyMultipleReplicas(BaseNetworkPolicy):
    ...
    def start(self):
        ...
        self.run_exec_cmd(namespace=namespace, pod_name=pod_name, cmd="wget http://google.com", repeat=1)
        self.run_exec_cmd(namespace=namespace, pod_name=pod_name, cmd="wget http://www.google.com", repeat=1)
