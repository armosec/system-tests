...
class NetworkPolicy(BaseNetworkPolicy):
    ...
    def start(self):
        ...
        self.wait_for_report(timeout=180, report_type=self.run_exec_cmd, namespace=namespace, pod_name=pod_name,
                             cmd="curl https://google.com")
        self.wait_for_report(timeout=180, report_type=self.run_exec_cmd, namespace=namespace, pod_name=pod_name,
                             cmd="curl https://wikipedia.org")
