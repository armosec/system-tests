...
SECURITY_RISKS_WORKFLOW_NAME = "security_risks_workflow"
VULNERABILITIES_WORKFLOW_NAME = "vulnerabilities_workflow"
COMPLIANCE_WORKFLOW_NAME = "compliance_workflow"
