...
class RelevantVulnerabilityScanningTests(object):
    ...
    def relevant_data_is_appended():
        ...
        return TestConfiguration(
            ...
            expected_SBOMs=[("redis-sleep", "configurations/relevant_cves/expected-result/wikijs/SBOM/redis_entrypoint_SBOM.json")],
            expected_filtered_SBOMs=[("redis-sleep", "configurations/relevant_cves/expected-result/wikijs/filteredSBOM/redis_sleep.json")],
            expected_updated_filtered_SBOMs=[("redis-sleep",  "configurations/relevant_cves/expected-result/wikijs/filteredSBOM/redis_sleep_long.json")],
