...
def tests = [
            ...
            ////  "vuln_scan_cve_exceptions":                                     ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            //// "vuln_scan_trigger_scan_registry_by_backend":                    ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            //"vuln_scan_test_public_registry_connectivity_by_backend" :                       ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            //"vuln_scan_test_public_registry_connectivity_excluded_by_backend":             ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            ...
            "ac_alpine_fix_image_no_relevancy_with_cronjob":      ["CA-AWS-DEV-JENKINS-EC2-FLEET-2X-LARGE",  "k8s"],
            ////"ac_5_fix_control_no_relevancy":       ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            ////"ac_1_1_fix_control_no_relevancy":     ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            ////"ac_6_fix_control_no_relevancy":       ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            ////"ac_3_fix_control_no_relevancy":       ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            ////"ac_alpine_fix_control_with_relevancy":              ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            //"ac_alpine_fix_image_no_relevancy":    ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            //"ac_5_fix_control_no_relevancy":    ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            ////  "ac_alpine_fix_control":              ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"],
            ////  "ac_5_fix_control":                   ["CA-AWS-DEV-JENKINS-EC2-FLEET-X-LARGE",  "k8s"]
             ]
