...
def tests = ["vuln_scan":                                                   ["CA-AWS-DEV-JENKINS-EC2-FLEET-2X-LARGE-RELEVANCY",  "k8s"],
            ...
            "vuln_scan_trigger_scan_registry_by_backend":                   ["CA-AWS-DEV-JENKINS-EC2-FLEET-2X-LARGE-RELEVANCY",  "k8s"],
            "vuln_scan_cve_exceptions":                                     ["CA-AWS-DEV-JENKINS-EC2-FLEET-2X-LARGE-RELEVANCY",  "k8s"],
             "vuln_scan_triggering_with_cron_job":                          ["CA-AWS-DEV-JENKINS-EC2-FLEET-2X-LARGE-RELEVANCY",  "k8s"],
